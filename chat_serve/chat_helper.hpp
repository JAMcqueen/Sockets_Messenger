...
#define LEAVE_CHAT "server has terminated chat session\0"
#define LEAVE_CHAT_LEN 35
#define LEAVE_CHAT_CLIENT "client has terminated chat session\0"
...
// name: sig_handler()
// purpose: catches interrupt signal
// args:
//		int sig_num: signal code
// precondition(s): none
